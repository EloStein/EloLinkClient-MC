package elolinkmc.de.util.config;

import com.mojang.serialization.Codec;
import elolinkmc.de.ElolinkMc;
...
public class ConfigFile {
    ...
    public void readFile() {
        try {
            ...
            ElolinkMc.LOGGER.warn("Failed to read config file '{}'\nException: {}", this.PATH, ExceptionUtil.makePretty(e));
        }
    }
    ...
    public void writeFile() {
        try {
            ...
            ElolinkMc.LOGGER.warn("Failed to write config file '{}'\nException: {}", this.PATH, ExceptionUtil.makePretty(e));
        }
    }
